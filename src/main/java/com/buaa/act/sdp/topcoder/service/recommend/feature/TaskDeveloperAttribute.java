 ...
 */
@Component
public class TaskDeveloperAttribute {

    private static final Logger logger = LoggerFactory.getLogger(TaskDeveloperAttribute.class);
     ...
     * @param items
     */
    public void getTaskFeatures(List<double[]> features, List<String> developers, TaskItem item, List<TaskItem> items) {
     ...
     * @param feature
     */
    public void generateStaticFeature(Set<String> set, TaskItem item, double[] feature) {
        int index = 0;
     ...
     * @return
     */
    public List<double[]> generateFeatures(TaskItem item, List<TaskItem> items, List<String> developers) {
        ...
        List<double[]> dynamicFeatures = dynamicMsg.getDeveloperDynamicFeature(items, item, developers);
    ...
    public void setDeveloperSkills(int index, double[] feature, Set<String> skills, Set<String> skill) {
